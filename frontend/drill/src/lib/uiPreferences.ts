...
const english = {
  practice: 'Practice', activity: 'Activity', bookActivity: 'Book Check-ins', knowledge: 'Knowledge', selectedHeatmap: 'Selected Heatmap', buildPaper: 'Build Paper', favorites: 'Favorites', nextTime: 'Next Time', bookFeel: 'Book Feel', insight: 'Insight',
...
const translations: Record<UiLanguage, Messages> = {
  en: english,
  'zh-CN': {
    practice: '练习', activity: '活跃记录', bookActivity: '书目打卡', knowledge: '知识点', selectedHeatmap: '严选题热力图', buildPaper: '组卷', favorites: '收藏', nextTime: '下次再看', bookFeel: '书目手感', insight: '洞察',
  ...
  ja: {
    practice: '練習', activity: 'アクティビティ', bookActivity: '教材チェックイン', knowledge: '知識', selectedHeatmap: '厳選問題ヒートマップ', buildPaper: '問題セット', favorites: 'お気に入り', nextTime: '次回', bookFeel: '教材の感覚', insight: 'インサイト',
