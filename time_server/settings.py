...
SECRET_KEY = 'django-insecure-fpzglblxozt$-1su^_e6t@)0)ag(b8xrau4p0p2fadlweir#+m'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# /root/time_server/time_server/settings.py
ALLOWED_HOSTS = ['47.95.10.128', '127.0.0.1', 'localhost']
